 ...
 */
#ifndef DEFAULT_GNC_APP_MSGDEFS_H
#define DEFAULT_GNC_APP_MSGDEFS_H

#include "common_types.h"
#include "gnc_app_fcncodes.h"

typedef struct GNC_APP_DisplayParam_Payload
{
...
typedef struct GNC_APP_HkTlm_Payload
{
    uint8 CommandCounter;
    uint8 CommandErrorCounter;
    uint8 spare[2];
} GNC_APP_HkTlm_Payload_t;
