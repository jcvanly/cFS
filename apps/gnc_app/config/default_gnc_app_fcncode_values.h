 ...
 */
#ifndef DEFAULT_GNC_APP_FCNCODE_VALUES_H
#define DEFAULT_GNC_APP_FCNCODE_VALUES_H

/************************************************************************
 * Macro Definitions
 ************************************************************************/

#define GNC_APP_CCVAL(x) GNC_APP_FunctionCode_##x

enum GNC_APP_FunctionCode_
{
    GNC_APP_FunctionCode_NOOP           = 0,
