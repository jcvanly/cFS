...
/**
 * @file
 *   This file contains the prototypes for the Nav_interface App Ground Command-handling functions
 */

#ifndef NAV_INTERFACE_APP_CMDS_H
#define NAV_INTERFACE_APP_CMDS_H
...
#endif /* NAV_INTERFACE_APP_CMDS_H */
