 ...
 *   message data types.
 *
 * This is a compatibility header for the "nav_interface_app_msg.h" file that has
 ...
 * dictionary tool.
 */
#ifndef DEFAULT_NAV_INTERFACE_APP_MSG_H
#define DEFAULT_NAV_INTERFACE_APP_MSG_H

#include "nav_interface_app_mission_cfg.h"
#include "nav_interface_app_msgdefs.h"
#include "nav_interface_app_msgstruct.h"
